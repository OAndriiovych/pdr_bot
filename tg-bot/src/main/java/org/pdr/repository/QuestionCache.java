...
public class QuestionCache implements QuestionRepository {
    ...
    private static Map<Integer, List<Question>> getQuestionsMapByTheme() {
        ...
        for (File f : new File("tg-bot/src/main/resources/questions").listFiles()) {
            String name = f.getName();
            int theme = Integer.parseInt(name.substring(0, name.indexOf(".json")));
            List<Question> questions = new JSONToQuestion("tg-bot/src/main/resources/questions/" + name).questions;
